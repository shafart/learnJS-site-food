...
function calc() {
  ...
  function getDуnamicInformation(selector) {
  ...
  ;
  getDуnamicInformation('#height');
  getDуnamicInformation('#weight');
  getDуnamicInformation('#age');
}
...
window.addEventListener('DOMContentLoaded', () => {
  ...
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_3__["default"])('.timer', '2023-08-06');
